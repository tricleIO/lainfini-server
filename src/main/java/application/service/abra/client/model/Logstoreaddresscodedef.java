...
public class Logstoreaddresscodedef   {
  ...
  **/
  ...
  public Logstoreaddresscodedef addRowsItem(Logstoreaddresscodedefrow rowsItem) {
  ...
  **/
  ...
  public void setRows(List<Logstoreaddresscodedefrow> rows) {
    this.rows = rows;
  }

  public Logstoreaddresscodedef hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  **/
  ...
  public Logstoreaddresscodedef name(String name) {
    this.name = name;
    return this;
  }
