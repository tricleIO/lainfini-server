...
public class Exchangedifference   {
  ...
  @SerializedName("vatdepositusage")
  private Boolean vatdepositusage = null;

  public Exchangedifference displayname(String displayname) {
  ...
  **/
  ...
  public Exchangedifference id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public Exchangedifference classid(String classid) {
  ...
  **/
  ...
  public Exchangedifference objversion(Integer objversion) {
  ...
  **/
  ...
  public Exchangedifference docqueueId(String docqueueId) {
  ...
  **/
  ...
  public Exchangedifference periodId(String periodId) {
  ...
  **/
  ...
  public Exchangedifference ordnumber(Integer ordnumber) {
  ...
  **/
  ...
  public Exchangedifference docdatedate(DateTime docdatedate) {
  ...
  **/
  ...
  public Exchangedifference createdbyId(String createdbyId) {
  ...
  **/
  ...
  public Exchangedifference correctedbyId(String correctedbyId) {
  ...
  **/
  ...
  public Exchangedifference newrelatedtype(Integer newrelatedtype) {
  ...
  **/
  ...
  public Exchangedifference newrelateddocumentId(String newrelateddocumentId) {
  ...
  **/
  ...
  public Exchangedifference accpresetdefId(String accpresetdefId) {
  ...
  **/
  ...
  public Exchangedifference firmId(String firmId) {
    this.firmId = firmId;
    return this;
  }
  ...
  **/
  ...
  public Exchangedifference firmofficeId(String firmofficeId) {
  ...
  **/
  ...
  public Exchangedifference personId(String personId) {
  ...
  **/
  ...
  public Exchangedifference description(String description) {
  ...
  **/
  ...
  public Exchangedifference accdatedate(DateTime accdatedate) {
  ...
  **/
  ...
  public Exchangedifference accdocqueueId(String accdocqueueId) {
  ...
  **/
  ...
  public Exchangedifference accountingtype(Integer accountingtype) {
  ...
  **/
  ...
  public Exchangedifference isaccounted(Boolean isaccounted) {
  ...
  **/
  ...
  public Exchangedifference dirty(Boolean dirty) {
    this.dirty = dirty;
    return this;
  }
  ...
  **/
  ...
  public Exchangedifference amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public Exchangedifference divisionId(String divisionId) {
  ...
  **/
  ...
  public Exchangedifference busorderId(String busorderId) {
  ...
  **/
  ...
  public Exchangedifference bustransactionId(String bustransactionId) {
  ...
  **/
  ...
  public Exchangedifference profit(Boolean profit) {
    this.profit = profit;
    return this;
  }
  ...
  **/
  ...
  public Exchangedifference currencyId(String currencyId) {
  ...
  **/
  ...
  public Exchangedifference countryId(String countryId) {
  ...
  **/
  ...
  public Exchangedifference refcurrencyId(String refcurrencyId) {
  ...
  **/
  ...
  public Exchangedifference localrefcurrencyId(String localrefcurrencyId) {
  ...
  **/
  ...
  public Exchangedifference busprojectId(String busprojectId) {
  ...
  **/
  ...
  public Exchangedifference pdocumentId(String pdocumentId) {
  ...
  **/
  ...
  public Exchangedifference pdocumenttype(String pdocumenttype) {
  ...
  **/
  ...
  public Exchangedifference vatdepositusage(Boolean vatdepositusage) {
    this.vatdepositusage = vatdepositusage;
    return this;
  }

   /**
   * příznak, zda souvisí se zúčtováním dzl [persistentní položka]
   * @return vatdepositusage
  **/
  @ApiModelProperty(example = "null", value = "příznak, zda souvisí se zúčtováním dzl [persistentní položka]")
  public Boolean getVatdepositusage() {
    return vatdepositusage;
  }

  public void setVatdepositusage(Boolean vatdepositusage) {
    this.vatdepositusage = vatdepositusage;
  }
  ...
  public boolean equals(Object o) {
    ...
    Exchangedifference exchangedifference = (Exchangedifference) o;
    return Objects.equals(this.displayname, exchangedifference.displayname) &&
        Objects.equals(this.id, exchangedifference.id) &&
        Objects.equals(this.classid, exchangedifference.classid) &&
        Objects.equals(this.objversion, exchangedifference.objversion) &&
        Objects.equals(this.docqueueId, exchangedifference.docqueueId) &&
        Objects.equals(this.periodId, exchangedifference.periodId) &&
        Objects.equals(this.ordnumber, exchangedifference.ordnumber) &&
        Objects.equals(this.docdatedate, exchangedifference.docdatedate) &&
        Objects.equals(this.createdbyId, exchangedifference.createdbyId) &&
        Objects.equals(this.correctedbyId, exchangedifference.correctedbyId) &&
        Objects.equals(this.newrelatedtype, exchangedifference.newrelatedtype) &&
        Objects.equals(this.newrelateddocumentId, exchangedifference.newrelateddocumentId) &&
        Objects.equals(this.accpresetdefId, exchangedifference.accpresetdefId) &&
        Objects.equals(this.firmId, exchangedifference.firmId) &&
        Objects.equals(this.firmofficeId, exchangedifference.firmofficeId) &&
        Objects.equals(this.personId, exchangedifference.personId) &&
        Objects.equals(this.description, exchangedifference.description) &&
        Objects.equals(this.accdatedate, exchangedifference.accdatedate) &&
        Objects.equals(this.accdocqueueId, exchangedifference.accdocqueueId) &&
        Objects.equals(this.accountingtype, exchangedifference.accountingtype) &&
        Objects.equals(this.isaccounted, exchangedifference.isaccounted) &&
        Objects.equals(this.dirty, exchangedifference.dirty) &&
        Objects.equals(this.amount, exchangedifference.amount) &&
        Objects.equals(this.divisionId, exchangedifference.divisionId) &&
        Objects.equals(this.busorderId, exchangedifference.busorderId) &&
        Objects.equals(this.bustransactionId, exchangedifference.bustransactionId) &&
        Objects.equals(this.profit, exchangedifference.profit) &&
        Objects.equals(this.currencyId, exchangedifference.currencyId) &&
        Objects.equals(this.countryId, exchangedifference.countryId) &&
        Objects.equals(this.refcurrencyId, exchangedifference.refcurrencyId) &&
        Objects.equals(this.localrefcurrencyId, exchangedifference.localrefcurrencyId) &&
        Objects.equals(this.busprojectId, exchangedifference.busprojectId) &&
        Objects.equals(this.pdocumentId, exchangedifference.pdocumentId) &&
        Objects.equals(this.pdocumenttype, exchangedifference.pdocumenttype) &&
        Objects.equals(this.vatdepositusage, exchangedifference.vatdepositusage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayname, id, classid, objversion, docqueueId, periodId, ordnumber, docdatedate, createdbyId, correctedbyId, newrelatedtype, newrelateddocumentId, accpresetdefId, firmId, firmofficeId, personId, description, accdatedate, accdocqueueId, accountingtype, isaccounted, dirty, amount, divisionId, busorderId, bustransactionId, profit, currencyId, countryId, refcurrencyId, localrefcurrencyId, busprojectId, pdocumentId, pdocumenttype, vatdepositusage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Exchangedifference {\n");
    ...
    sb.append("    vatdepositusage: ").append(toIndentedString(vatdepositusage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
