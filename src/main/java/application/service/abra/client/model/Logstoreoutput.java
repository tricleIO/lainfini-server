...
public class Logstoreoutput   {
  ...
  @SerializedName("rows")
  private List<Logstoreoutputrow> rows = new ArrayList<Logstoreoutputrow>();
  ...
  public Logstoreoutput displayname(String displayname) {
  ...
  **/
  ...
  public Logstoreoutput id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public Logstoreoutput classid(String classid) {
  ...
  **/
  ...
  public Logstoreoutput objversion(Integer objversion) {
  ...
  **/
  ...
  public Logstoreoutput rows(List<Logstoreoutputrow> rows) {
    this.rows = rows;
    return this;
  }

  public Logstoreoutput addRowsItem(Logstoreoutputrow rowsItem) {
    this.rows.add(rowsItem);
    return this;
  }

   /**
   * Řádky; kolekce bo vyskladnění z pozic - řádek [nepersistentní položka]
   * @return rows
  **/
  @ApiModelProperty(example = "null", value = "Řádky; kolekce bo vyskladnění z pozic - řádek [nepersistentní položka]")
  public List<Logstoreoutputrow> getRows() {
    return rows;
  }

  public void setRows(List<Logstoreoutputrow> rows) {
    this.rows = rows;
  }

  public Logstoreoutput docqueueId(String docqueueId) {
  ...
  **/
  ...
  public Logstoreoutput periodId(String periodId) {
  ...
  **/
  ...
  public Logstoreoutput ordnumber(Integer ordnumber) {
  ...
  **/
  ...
  public Logstoreoutput docdatedate(DateTime docdatedate) {
  ...
  **/
  ...
  public Logstoreoutput createdbyId(String createdbyId) {
  ...
  **/
  ...
  public Logstoreoutput correctedbyId(String correctedbyId) {
  ...
  **/
  ...
  public Logstoreoutput newrelatedtype(Integer newrelatedtype) {
  ...
  **/
  ...
  public Logstoreoutput newrelateddocumentId(String newrelateddocumentId) {
  ...
  **/
  ...
  public Logstoreoutput documenttype(String documenttype) {
  ...
  **/
  ...
  public Logstoreoutput storedocumenttype(String storedocumenttype) {
  ...
  **/
  ...
  public Logstoreoutput storedocumentId(String storedocumentId) {
  ...
  **/
  ...
  public Logstoreoutput storegatewayId(String storegatewayId) {
  ...
  **/
  ...
  public Logstoreoutput executed(Boolean executed) {
  ...
  **/
  ...
  public Logstoreoutput nostoredocument(Boolean nostoredocument) {
  ...
  **/
  ...
  public Logstoreoutput description(String description) {
  ...
  **/
  ...
  public Logstoreoutput externalnumber(String externalnumber) {
  ...
  **/
  ...
  public Logstoreoutput firmId(String firmId) {
    this.firmId = firmId;
    return this;
  }
  ...
  **/
  ...
  public Logstoreoutput storemanId(String storemanId) {
  ...
  **/
  ...
  public Logstoreoutput reservedfordoctype(String reservedfordoctype) {
  ...
  **/
  ...
  public Logstoreoutput reservedfordocId(String reservedfordocId) {
  ...
  **/
  ...
  public Logstoreoutput masterdocclsid(String masterdocclsid) {
  ...
  **/
  ...
  public Logstoreoutput masterdocumentId(String masterdocumentId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Logstoreoutput logstoreoutput = (Logstoreoutput) o;
    return Objects.equals(this.displayname, logstoreoutput.displayname) &&
        Objects.equals(this.id, logstoreoutput.id) &&
        Objects.equals(this.classid, logstoreoutput.classid) &&
        Objects.equals(this.objversion, logstoreoutput.objversion) &&
        Objects.equals(this.rows, logstoreoutput.rows) &&
        Objects.equals(this.docqueueId, logstoreoutput.docqueueId) &&
        Objects.equals(this.periodId, logstoreoutput.periodId) &&
        Objects.equals(this.ordnumber, logstoreoutput.ordnumber) &&
        Objects.equals(this.docdatedate, logstoreoutput.docdatedate) &&
        Objects.equals(this.createdbyId, logstoreoutput.createdbyId) &&
        Objects.equals(this.correctedbyId, logstoreoutput.correctedbyId) &&
        Objects.equals(this.newrelatedtype, logstoreoutput.newrelatedtype) &&
        Objects.equals(this.newrelateddocumentId, logstoreoutput.newrelateddocumentId) &&
        Objects.equals(this.documenttype, logstoreoutput.documenttype) &&
        Objects.equals(this.storedocumenttype, logstoreoutput.storedocumenttype) &&
        Objects.equals(this.storedocumentId, logstoreoutput.storedocumentId) &&
        Objects.equals(this.storegatewayId, logstoreoutput.storegatewayId) &&
        Objects.equals(this.executed, logstoreoutput.executed) &&
        Objects.equals(this.nostoredocument, logstoreoutput.nostoredocument) &&
        Objects.equals(this.description, logstoreoutput.description) &&
        Objects.equals(this.externalnumber, logstoreoutput.externalnumber) &&
        Objects.equals(this.firmId, logstoreoutput.firmId) &&
        Objects.equals(this.storemanId, logstoreoutput.storemanId) &&
        Objects.equals(this.reservedfordoctype, logstoreoutput.reservedfordoctype) &&
        Objects.equals(this.reservedfordocId, logstoreoutput.reservedfordocId) &&
        Objects.equals(this.masterdocclsid, logstoreoutput.masterdocclsid) &&
        Objects.equals(this.masterdocumentId, logstoreoutput.masterdocumentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Logstoreoutput {\n");
