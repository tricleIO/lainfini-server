...
public class Retirementreportdef   {
  ...
  **/
  ...
  public Retirementreportdef addRowsItem(Retirementreportdefrow rowsItem) {
  ...
  **/
  ...
  public void setRows(List<Retirementreportdefrow> rows) {
    this.rows = rows;
  }

  public Retirementreportdef name(String name) {
    this.name = name;
    return this;
  }
