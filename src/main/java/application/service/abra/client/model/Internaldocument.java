...
public class Internaldocument   {
  ...
  @SerializedName("rows")
  private List<Internaldocumentrow> rows = new ArrayList<Internaldocumentrow>();
  ...
  public Internaldocument displayname(String displayname) {
  ...
  **/
  ...
  public Internaldocument id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument classid(String classid) {
  ...
  **/
  ...
  public Internaldocument objversion(Integer objversion) {
  ...
  **/
  ...
  public Internaldocument rows(List<Internaldocumentrow> rows) {
    this.rows = rows;
    return this;
  }

  public Internaldocument addRowsItem(Internaldocumentrow rowsItem) {
    this.rows.add(rowsItem);
    return this;
  }

   /**
   * Řádky; kolekce bo interní doklad - řádek [nepersistentní položka]
   * @return rows
  **/
  @ApiModelProperty(example = "null", value = "Řádky; kolekce bo interní doklad - řádek [nepersistentní položka]")
  public List<Internaldocumentrow> getRows() {
    return rows;
  }

  public void setRows(List<Internaldocumentrow> rows) {
    this.rows = rows;
  }

  public Internaldocument docqueueId(String docqueueId) {
  ...
  **/
  ...
  public Internaldocument periodId(String periodId) {
  ...
  **/
  ...
  public Internaldocument ordnumber(Integer ordnumber) {
  ...
  **/
  ...
  public Internaldocument docdatedate(DateTime docdatedate) {
  ...
  **/
  ...
  public Internaldocument createdbyId(String createdbyId) {
  ...
  **/
  ...
  public Internaldocument correctedbyId(String correctedbyId) {
  ...
  **/
  ...
  public Internaldocument newrelatedtype(Integer newrelatedtype) {
  ...
  **/
  ...
  public Internaldocument newrelateddocumentId(String newrelateddocumentId) {
  ...
  **/
  ...
  public Internaldocument accpresetdefId(String accpresetdefId) {
  ...
  **/
  ...
  public Internaldocument firmId(String firmId) {
    this.firmId = firmId;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument firmofficeId(String firmofficeId) {
  ...
  **/
  ...
  public Internaldocument personId(String personId) {
  ...
  **/
  ...
  public Internaldocument description(String description) {
  ...
  **/
  ...
  public Internaldocument accdatedate(DateTime accdatedate) {
  ...
  **/
  ...
  public Internaldocument accdocqueueId(String accdocqueueId) {
  ...
  **/
  ...
  public Internaldocument accountingtype(Integer accountingtype) {
  ...
  **/
  ...
  public Internaldocument isaccounted(Boolean isaccounted) {
  ...
  **/
  ...
  public Internaldocument dirty(Boolean dirty) {
    this.dirty = dirty;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument countryId(String countryId) {
  ...
  **/
  ...
  public Internaldocument currencyId(String currencyId) {
  ...
  **/
  ...
  public Internaldocument currrate(Double currrate) {
  ...
  **/
  ...
  public Internaldocument refcurrrate(Double refcurrrate) {
  ...
  **/
  ...
  public Internaldocument coef(Integer coef) {
    this.coef = coef;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument localcoef(Integer localcoef) {
  ...
  **/
  ...
  public Internaldocument zoneId(String zoneId) {
    this.zoneId = zoneId;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument localzoneId(String localzoneId) {
  ...
  **/
  ...
  public Internaldocument refcurrencyId(String refcurrencyId) {
  ...
  **/
  ...
  public Internaldocument localrefcurrencyId(String localrefcurrencyId) {
  ...
  **/
  ...
  public Internaldocument currrateinfo(String currrateinfo) {
  ...
  **/
  ...
  public Internaldocument amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument localamount(Double localamount) {
  ...
  **/
  ...
  public Internaldocument note(String note) {
    this.note = note;
    return this;
  }
  ...
  **/
  ...
  public Internaldocument comment(String comment) {
  ...
  **/
  ...
  public Internaldocument flag(Integer flag) {
    this.flag = flag;
    return this;
  }

   /**
   * příznak [persistentní položka]
   * @return flag
  **/
  @ApiModelProperty(example = "null", value = "příznak [persistentní položka]")
  ...
  public Internaldocument createdatdate(DateTime createdatdate) {
  ...
  **/
  ...
  public Internaldocument correctedatdate(DateTime correctedatdate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Internaldocument internaldocument = (Internaldocument) o;
    return Objects.equals(this.displayname, internaldocument.displayname) &&
        Objects.equals(this.id, internaldocument.id) &&
        Objects.equals(this.classid, internaldocument.classid) &&
        Objects.equals(this.objversion, internaldocument.objversion) &&
        Objects.equals(this.rows, internaldocument.rows) &&
        Objects.equals(this.docqueueId, internaldocument.docqueueId) &&
        Objects.equals(this.periodId, internaldocument.periodId) &&
        Objects.equals(this.ordnumber, internaldocument.ordnumber) &&
        Objects.equals(this.docdatedate, internaldocument.docdatedate) &&
        Objects.equals(this.createdbyId, internaldocument.createdbyId) &&
        Objects.equals(this.correctedbyId, internaldocument.correctedbyId) &&
        Objects.equals(this.newrelatedtype, internaldocument.newrelatedtype) &&
        Objects.equals(this.newrelateddocumentId, internaldocument.newrelateddocumentId) &&
        Objects.equals(this.accpresetdefId, internaldocument.accpresetdefId) &&
        Objects.equals(this.firmId, internaldocument.firmId) &&
        Objects.equals(this.firmofficeId, internaldocument.firmofficeId) &&
        Objects.equals(this.personId, internaldocument.personId) &&
        Objects.equals(this.description, internaldocument.description) &&
        Objects.equals(this.accdatedate, internaldocument.accdatedate) &&
        Objects.equals(this.accdocqueueId, internaldocument.accdocqueueId) &&
        Objects.equals(this.accountingtype, internaldocument.accountingtype) &&
        Objects.equals(this.isaccounted, internaldocument.isaccounted) &&
        Objects.equals(this.dirty, internaldocument.dirty) &&
        Objects.equals(this.countryId, internaldocument.countryId) &&
        Objects.equals(this.currencyId, internaldocument.currencyId) &&
        Objects.equals(this.currrate, internaldocument.currrate) &&
        Objects.equals(this.refcurrrate, internaldocument.refcurrrate) &&
        Objects.equals(this.coef, internaldocument.coef) &&
        Objects.equals(this.localcoef, internaldocument.localcoef) &&
        Objects.equals(this.zoneId, internaldocument.zoneId) &&
        Objects.equals(this.localzoneId, internaldocument.localzoneId) &&
        Objects.equals(this.refcurrencyId, internaldocument.refcurrencyId) &&
        Objects.equals(this.localrefcurrencyId, internaldocument.localrefcurrencyId) &&
        Objects.equals(this.currrateinfo, internaldocument.currrateinfo) &&
        Objects.equals(this.amount, internaldocument.amount) &&
        Objects.equals(this.localamount, internaldocument.localamount) &&
        Objects.equals(this.note, internaldocument.note) &&
        Objects.equals(this.comment, internaldocument.comment) &&
        Objects.equals(this.flag, internaldocument.flag) &&
        Objects.equals(this.createdatdate, internaldocument.createdatdate) &&
        Objects.equals(this.correctedatdate, internaldocument.correctedatdate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayname, id, classid, objversion, rows, docqueueId, periodId, ordnumber, docdatedate, createdbyId, correctedbyId, newrelatedtype, newrelateddocumentId, accpresetdefId, firmId, firmofficeId, personId, description, accdatedate, accdocqueueId, accountingtype, isaccounted, dirty, countryId, currencyId, currrate, refcurrrate, coef, localcoef, zoneId, localzoneId, refcurrencyId, localrefcurrencyId, currrateinfo, amount, localamount, note, comment, flag, createdatdate, correctedatdate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Internaldocument {\n");
