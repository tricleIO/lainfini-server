...
public class Cashpaidrow   {
  ...
  public Cashpaidrow displayname(String displayname) {
  ...
  **/
  ...
  public Cashpaidrow id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public Cashpaidrow classid(String classid) {
  ...
  **/
  ...
  public Cashpaidrow objversion(Integer objversion) {
  ...
  **/
  ...
  public Cashpaidrow parentId(String parentId) {
    this.parentId = parentId;
    return this;
  }

   /**
   * vlastník; id objektu pokladní výdej [persistentní položka]
   * @return parentId
  **/
  @ApiModelProperty(example = "null", value = "vlastník; id objektu pokladní výdej [persistentní položka]")
  ...
  public Cashpaidrow posindex(Integer posindex) {
  ...
  **/
  ...
  public Cashpaidrow tamount(Double tamount) {
  ...
  **/
  ...
  public Cashpaidrow localtamount(Double localtamount) {
  ...
  **/
  ...
  public Cashpaidrow cdconfirmedrows(List<Cdconfirmlink> cdconfirmedrows) {
    this.cdconfirmedrows = cdconfirmedrows;
    return this;
  }

  public Cashpaidrow addCdconfirmedrowsItem(Cdconfirmlink cdconfirmedrowsItem) {
  ...
  **/
  ...
  public Cashpaidrow cdconfirmedamount(Double cdconfirmedamount) {
  ...
  **/
  ...
  public Cashpaidrow divisionId(String divisionId) {
  ...
  **/
  ...
  public Cashpaidrow busorderId(String busorderId) {
  ...
  **/
  ...
  public Cashpaidrow bustransactionId(String bustransactionId) {
  ...
  **/
  ...
  public Cashpaidrow tamountwithoutvat(Double tamountwithoutvat) {
  ...
  **/
  ...
  public Cashpaidrow vatrateId(String vatrateId) {
  ...
  **/
  ...
  public Cashpaidrow vatindexId(String vatindexId) {
  ...
  **/
  ...
  public Cashpaidrow vatrate(Double vatrate) {
  ...
  **/
  ...
  public Cashpaidrow localtamountwithoutvat(Double localtamountwithoutvat) {
  ...
  **/
  ...
  public Cashpaidrow busprojectId(String busprojectId) {
  ...
  **/
  ...
  public Cashpaidrow vatmode(Integer vatmode) {
  ...
  **/
  ...
  public Cashpaidrow text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public Cashpaidrow vattamount(Double vattamount) {
  ...
  **/
  ...
  public Cashpaidrow drcarticleId(String drcarticleId) {
  ...
  **/
  ...
  public Cashpaidrow drcquantity(Double drcquantity) {
  ...
  **/
  ...
  public Cashpaidrow drcqunit(String drcqunit) {
  ...
  **/
  ...
  public Cashpaidrow localbyhand(Boolean localbyhand) {
  ...
  **/
  ...
  public Cashpaidrow localvattamount(Double localvattamount) {
  ...
  **/
  ...
  public Cashpaidrow usedratio(Boolean usedratio) {
  ...
  **/
  ...
  public Cashpaidrow expensetypeId(String expensetypeId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Cashpaidrow cashpaidrow = (Cashpaidrow) o;
    return Objects.equals(this.displayname, cashpaidrow.displayname) &&
        Objects.equals(this.id, cashpaidrow.id) &&
        Objects.equals(this.classid, cashpaidrow.classid) &&
        Objects.equals(this.objversion, cashpaidrow.objversion) &&
        Objects.equals(this.parentId, cashpaidrow.parentId) &&
        Objects.equals(this.posindex, cashpaidrow.posindex) &&
        Objects.equals(this.tamount, cashpaidrow.tamount) &&
        Objects.equals(this.localtamount, cashpaidrow.localtamount) &&
        Objects.equals(this.cdconfirmedrows, cashpaidrow.cdconfirmedrows) &&
        Objects.equals(this.cdconfirmedamount, cashpaidrow.cdconfirmedamount) &&
        Objects.equals(this.divisionId, cashpaidrow.divisionId) &&
        Objects.equals(this.busorderId, cashpaidrow.busorderId) &&
        Objects.equals(this.bustransactionId, cashpaidrow.bustransactionId) &&
        Objects.equals(this.tamountwithoutvat, cashpaidrow.tamountwithoutvat) &&
        Objects.equals(this.vatrateId, cashpaidrow.vatrateId) &&
        Objects.equals(this.vatindexId, cashpaidrow.vatindexId) &&
        Objects.equals(this.vatrate, cashpaidrow.vatrate) &&
        Objects.equals(this.localtamountwithoutvat, cashpaidrow.localtamountwithoutvat) &&
        Objects.equals(this.busprojectId, cashpaidrow.busprojectId) &&
        Objects.equals(this.vatmode, cashpaidrow.vatmode) &&
        Objects.equals(this.text, cashpaidrow.text) &&
        Objects.equals(this.vattamount, cashpaidrow.vattamount) &&
        Objects.equals(this.drcarticleId, cashpaidrow.drcarticleId) &&
        Objects.equals(this.drcquantity, cashpaidrow.drcquantity) &&
        Objects.equals(this.drcqunit, cashpaidrow.drcqunit) &&
        Objects.equals(this.localbyhand, cashpaidrow.localbyhand) &&
        Objects.equals(this.localvattamount, cashpaidrow.localvattamount) &&
        Objects.equals(this.usedratio, cashpaidrow.usedratio) &&
        Objects.equals(this.expensetypeId, cashpaidrow.expensetypeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayname, id, classid, objversion, parentId, posindex, tamount, localtamount, cdconfirmedrows, cdconfirmedamount, divisionId, busorderId, bustransactionId, tamountwithoutvat, vatrateId, vatindexId, vatrate, localtamountwithoutvat, busprojectId, vatmode, text, vattamount, drcarticleId, drcquantity, drcqunit, localbyhand, localvattamount, usedratio, expensetypeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Cashpaidrow {\n");
